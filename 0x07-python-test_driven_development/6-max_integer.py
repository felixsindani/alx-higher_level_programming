...
class TestMaxInteger(unittest.TestCase):
    ...
    def test_no_args(self):
        """Tests when no arg are passed to function"""
        self.assertIsNone(max_integer())

    def test_one_element(self):
        """Tests for only one number in list"""
        o = [1]
        self.assertEqual(max_integer(o), 1)

    def test_positive_end(self):
        """Tests for all pos with max at end"""
        e = [2, 10, 8, 36, 14, 50]
        self.assertEqual(max_integer(e), 50)

    def test_positive_middle(self):
        """Tests for all pos with max in middle"""
        m = [2, 10, 8, 360, 14, 50]
        self.assertEqual(max_integer(m), 360)

    def test_positive_beginning(self):
        """Tests for all pos with max at beginning"""
        b = [200, 10, 8, 36, 14, 50]
